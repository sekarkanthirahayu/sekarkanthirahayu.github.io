...
<head>
	...
	<title>SIM KOST NASAPATMA</title>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										SISTEM INFORMASI MANAJEMEN KOST NASAPATMA
									</b>
								</span>
							</a>
						</li>
		...
		<footer class="main-footer">
			...
			<center>
				<strong>Copyright &copy;
					<a href="https://www.youtube.com/channel/UCDxjOzW7F0JOkltlXT6g7AQ">Sekar Kanthi Rahayu</a>.</strong> All rights reserved.
			</center>
		</footer>
